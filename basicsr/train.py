    ...
    while current_iter <= total_iters:
        ...
        while train_data is not None:
            ...
            if opt.get('val') is not None and (current_iter % opt['val']['val_freq'] == 0):
                ...
                time_run_train_log = time.time() - time_log_iter
                time_log_iter = time.time() # update time_log_iter
                ...
                time_run_val = time.time() - time_val_begin
